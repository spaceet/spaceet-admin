...
const Input = React.forwardRef<HTMLInputElement, InputProps>(
	({ className, error, label, required, type, wrapperClassName, ...props }, ref) => {
		...
		return (
			<div className={cn("flex w-full flex-col gap-2", wrapperClassName)}>
				...
				<div className="flex h-[45px] w-full items-center gap-2 rounded-md border border-neutral-400 px-3 py-2">
					<input
